# Ansvarsfriskrivning och juridisk information för sie-mcp
...
> - **Maskeringsfunktionen är inte ett skydd du kan förlita dig på.** Den är ofullständig och har kända begränsningar — personuppgifter kan nå en extern AI-leverantör i klartext utan att du varnas. Se [DISCLAIMER_AND_TERMS.md](DISCLAIMER_AND_TERMS.md) avsnitt 6.
